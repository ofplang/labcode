...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    factory = labcode_backend_factory(seconds_per_tick=args.seconds_per_tick, speed=args.speed)

    try:
        # Validation already ran at the front doors above, so run trusting.
        result = run_workflow(
            args.workflow,
            args.env,
            boundary,
